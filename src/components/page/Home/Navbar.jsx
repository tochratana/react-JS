      ...
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <button
              type="button"
              className="mr-2 relative rounded-full bg-white dark:bg-gray-800 p-1 text-gray-400 hover:text-black dark:hover:text-white"
            >
            ...
            <button
              type="button"
              className="hover:text-black relative rounded-full dark:bg-gray-800 p-1 text-gray-400 dark:hover:text-white"
